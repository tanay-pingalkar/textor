...
export type BasicCommentsFragment = { __typename?: "Comments" } & Pick<
  Comments,
  "id" | "body" | "me" | "upvoted" | "downvoted" | "totalVotes"
>;

export type BasicPostFragment = { __typename?: "Posts" } & Pick<
  Posts,
  | "id"
  | "title"
  | "body"
...
export type CommentMutation = { __typename?: "Mutation" } & {
  comment: { __typename?: "commentResponse" } & Pick<CommentResponse, "msg"> & {
      comment?: Maybe<
        { __typename?: "Comments" } & Pick<Comments, "children" | "parent"> & {
...
export type EditPostMutation = { __typename?: "Mutation" } & {
  edit: { __typename?: "postResponse" } & Pick<PostResponse, "msg"> & {
...
export type EditCommentMutation = { __typename?: "Mutation" } & {
  editComment: { __typename?: "commentResponse" } & Pick<
    CommentResponse,
    "msg"
  > & { comment?: Maybe<{ __typename?: "Comments" } & Pick<Comments, "body">> };
};
...
export type ProfileQuery = { __typename?: "Query" } & {
  ...
  > & {
      user?: Maybe<
        ...
        > & { posts: Array<{ __typename?: "Posts" } & BasicPostFragment> }
      >;
    };
};
...
export type ProfileWithCommentsQuery = { __typename?: "Query" } & {
  profile: { __typename?: "profileResponse" } & Pick<
    ProfileResponse,
    "msg" | "me"
  > & {
      user?: Maybe<
        ...
        > & {
            comments: Array<
              { __typename?: "Comments" } & {
                post: { __typename?: "Posts" } & Pick<Posts, "id">;
              } & BasicCommentsFragment
            >;
          }
      >;
...
export function getSdk(
  ...
  return {
    ...
    editPost(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<EditPostMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<EditPostMutation>(EditPostDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "editPost"
    ...
    editComment(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<EditCommentMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<EditCommentMutation>(EditCommentDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "editComment"
    ...
    profileWithComments(
      variables: ProfileWithCommentsQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<ProfileWithCommentsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ProfileWithCommentsQuery>(
            ProfileWithCommentsDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "profileWithComments"
